...
XIVQL_COMMIT="5a205c0f44fce973ab0806e50b77d8c16d395d68"

SRC_URI="
https://github.com/ottercorp/XIVLauncher.Core/archive/refs/tags/${PV}.tar.gz -> ${P}.tar.gz
https://github.com/ottercorp/FFXIVQuickLauncher/archive/${XIVQL_COMMIT}.tar.gz -> FFXIVQuickLauncher-${XIVQL_COMMIT}.tar.gz
${NUGET_URIS}
"
...
src_install() {
	...
	dotnet-pkg-base_dolauncher "/usr/share/${P}/XIVLauncher.Core" "xivlauncher-cn"
